...
4 - We cannot use payload `<script>alert('XSS')</script>` in name field directly as the number of characters is restricted. The 'Message' field seems to be filtering out html tags so we foxus on name field.
